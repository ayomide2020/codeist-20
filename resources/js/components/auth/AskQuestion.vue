        ...
        <div class="container-fluid m-0 p-3">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-8 col-lg-8 p-0 col-md-12 col-12">
                        <form action="" class="container p-4 contain" method="POST">
                    ...
                    <div class="col-xl-3 col-lg-3 p-0 col-md-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                Guide to Ask Question
                            </div>
                            <div class="card-body">
                                <p class="card-text">
                                ...
                                <div class="col-12 p-0">
                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Describe what you've tried</a>
