        ...
        <div class="container-fluid m-0 p-3">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-8 mt-5 order-md-2 order-lg-1 order-sm-2 col-lg-8 p-0 m-0 col-md-12 col-12">
                        <form action="" class="container-fluid p-4 contain" method="POST">
                            ...
                            <div class="mb-5">
                                ...
                                <span class="card-subtitle text-muted">Be specific and imagine you’re asking a question to another person</span>
                            </div>
                    ...
                    <div class="col-xl-3 mt-5 order-lg-2 order-md-1 order-sm-1 mt-xl-0 mt-lg-0 col-lg-3 p-0 col-md-12 col-12">
                        <div class="mt-4 card">
                            ...
                            <div class="card-body px-2">
                                ...
                                <div class="col-12 p-0">
                                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Summarize the Problem</a>
                                        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Say what you've tried</a>
                                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Show some codes</a>
                                    </div>
                                </div>
