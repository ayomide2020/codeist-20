  ...
  <nav class="bg navbar navbar-dark fixed-top py-5">
    ...
    >
      ...
      <div class="align-items-center">
        <router-link :to="{name:'tags'}" class="text-muted text-decoration-none">Tags</router-link>
        <router-link :to="{name:'topics'}" class="text-muted text-decoration-none ml-3">Topics</router-link>
